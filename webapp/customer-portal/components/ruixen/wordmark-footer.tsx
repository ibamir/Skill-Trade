...
/* ── Radial shine gradient — follows cursor, tinted with the primary color ── */

function makeShine(x: number, y: number): string {
    return `radial-gradient(ellipse 100% 100% at ${x.toFixed(1)}% ${y.toFixed(1)}%, color-mix(in srgb, var(--primary) 88%, transparent) 0%, color-mix(in srgb, var(--primary) 62%, transparent) 24%, color-mix(in srgb, var(--primary) 34%, transparent) 50%, color-mix(in srgb, var(--primary) 16%, transparent) 100%)`
}
